...
//           </div>
//           <div className="grid gap-4">
//             <Input id="name" name="name" type="text" placeholder="John Doe" value={name} onChange={handleChange} required />
//             <Input id="email" name="email" type="email" placeholder="m@example.com" value={email} onChange={handleChange} required />
...
//               {loading ? <SpecialLoadingButton content="Signing Up..." /> : "Register"}
//             </Button>
//             <p className="text-center text-sm">
